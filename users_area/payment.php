...
?>
    ...
    <div class="container">
        <h1 class="h3 mb-4 mt-4 text-center">Order/Payment Details</h1>
        <div class="row">
           <div class="col-lg-9">
                            ...
                            <div class="accordion-body">
                                <div class="px-2 col-lg-6 mb-3">
                                    ...
                                    <a href="order.php?user_id=<?php echo $user_id ?>">
                                       <label class="form-label">Pay Offline</label>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="p-3 bg-light bg-opacity-10">
                        <h6 class="card-title mb-3">Order Summary</h6>
                            ...
                            <hr>
                                ...
                                <button class="btn btn-primary w-100 mt-2" id="placeOrderBtn">Place order</button>
                    </div>
                </div>
            </div>
        </div>
