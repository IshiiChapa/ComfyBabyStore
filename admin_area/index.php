...
<head>
    ...
    <title>Comfy Baby Admin Dashboard</title>
    <!--bootstarp Css link -->
...
<body>
    ...
    <div class="container-fluid p-0">
        <!--first child-->
        <nav class="navbar navbar-expand-lg navbar0light bg-info">
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                <div class="p-3">
                    ...
                    <p class="text-1ight text-center">Admin Name</p>
                </div>
        ...
        <!-- last child -->
<div class="bg-info p-5 text-center footer">
    <p>All rights reserved Designed by ComfyBaby Store-2023</p>
</div>
    </div>
